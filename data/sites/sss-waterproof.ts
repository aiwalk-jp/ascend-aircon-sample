...
export const sssWaterproof: SiteData = {
  slug: 'sss-waterproof',
  logoText: 'S',
  theme: { primary: '#14263d', secondary: '#445569', accent: '#7f9bb3' },
  name: 'SSS興業',
  representative: '代表者　関　直人',
  license: '栃木県知事許可 第026974号',
  subName: '建物を雨水から守る防水工事',
  tagline: '宇都宮市周辺の建物を雨水から守る、\n確かな防水工事。',
  lead: '屋上・ベランダの防水から、シート防水・ウレタン防水、雨漏り対応まで。建物の状態に合わせて的確に施工します。',
  description: 'SSS興業は、住宅・ビル・マンションの防水工事を行います。建物を雨水から守り、長持ちさせるための施工を丁寧に行います。',
  area: '宇都宮市周辺対応',
  areaNote: '宇都宮市周辺のお客様へ迅速に対応いたします',
  tel: '028-307-2812',
  hours: 'お電話でお気軽にご相談ください',
  address: '〒321-0983 栃木県宇都宮市御幸本町4872-113',
  mapUrl: 'https://www.google.com/maps/place/SSS%E8%88%88%E6%A5%AD%EF%BC%88%E3%82%B9%E3%83%AA%E3%83%BC%E3%82%A8%E3%82%B9%E3%82%B3%E3%82%A6%E3%82%AE%E3%83%A7%E3%82%A6%EF%BC%89/data=!4m2!3m1!1s0x0:0x4e56a19a37fd1797?sa=X&ved=1t:2428&ictx=111',
  contactTitle: '防水工事・雨漏り対策のこと、まずはご相談ください。',
  contactDescription: '現地調査・お見積り・ご相談など、お電話でお気軽にお問い合わせください。',
  heroImage: '/images/base-waterproof/hero.jpg',
  serviceHeroImage: '/images/base-waterproof/svctop.jpg',
  stats: [
  ...
  services: [
    { name: 'ウレタン防水', label: 'URETHANE', text: '複雑な形状にも対応しやすいウレタン防水で、屋上やベランダを守ります。', image: '/images/base-waterproof/svc1.jpg' },
    { name: 'シート防水', label: 'SHEET', text: '塩ビ・ゴムシートによる防水で、広い面を効率よく施工します。', image: '/images/base-waterproof/svc2.jpg' },
    { name: 'FRP防水', label: 'FRP', text: '軽量で丈夫なFRP防水で、ベランダや小面積の防水に対応します。', image: '/images/base-waterproof/svc3.jpg' },
    { name: 'ベランダ・屋上防水', label: 'ROOFTOP', text: 'ベランダ・屋上の防水改修で、雨水の侵入を防ぎます。', image: '/images/base-waterproof/svc4.jpg' },
    { name: '雨漏り対応', label: 'LEAK', text: '原因を調査し、写真をもとに分かりやすくご説明して補修します。', image: '/images/base-waterproof/svc5.jpg' },
    { name: 'シーリング工事', label: 'SEALING', text: '外壁の目地やサッシまわりのシーリングで、防水性を高めます。', image: '/images/base-waterproof/svc6.jpg' },
  ],
  strengths: [
